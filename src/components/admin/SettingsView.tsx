    ...
    return (
        <div className="flex flex-col gap-10 font-bold">
            <div className="flex justify-between items-end">
                <div>
                    <h1 className="text-3xl font-heading tracking-tight text-white mb-1 uppercase">Store Settings</h1>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <button onClick={() => broadcastAlert('System reset requested.', 'warning')} className="premium-button px-6 py-3 rounded-xl text-[9px] font-black tracking-widest uppercase text-black">Reset System</button>
                </div>
            </div>

            <div className="glass-card rounded-[3rem] border border-white/5 p-10 shadow-2xl relative overflow-hidden group font-bold">
                ...
                <div className="flex flex-col gap-6 relative z-10">
                    {settingsCategories.map((category, index) => (
                        <motion.button
                            ...
                            className="w-full bg-[#121212]/30 hover:bg-white/[0.05] border border-white/5 hover:border-gold/30 rounded-[2.5rem] p-10 flex justify-between items-center group transition-all duration-500 overflow-hidden relative"
                        >
                            ...
                            <div className="text-left flex items-center gap-10">
                                <div className="w-16 h-16 rounded-2xl bg-white/[0.05] border border-white/5 flex items-center justify-center text-white/20 group-hover:text-gold transition-colors shadow-inner group-hover:scale-105 transition-transform duration-500">
                                    {category.icon}
                                </div>
                                <div className="flex flex-col gap-2">
                                    <h4 className="text-2xl font-heading text-white group-hover:text-gold transition-colors tracking-tight uppercase">{category.title}</h4>
                                    <p className="text-[11px] font-light text-white/30 truncate max-w-2xl uppercase tracking-[0.1em]">{category.desc}</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-6">
                                ...
                                <div className="w-12 h-12 rounded-full border border-white/5 flex items-center justify-center group-hover:border-gold/30 transition-all transform group-hover:rotate-12">
            ...
            <div className="flex justify-center items-center gap-8 py-10 opacity-50 font-bold">
