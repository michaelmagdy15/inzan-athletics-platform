  ...
  const settingsCategories = [
    {
      ...
      desc: "Manage gym name, timezone, and local settings.",
      icon: <Globe size={18} />,
    },
    {
      id: "governance",
      title: "Admin & Access",
      desc: "Manage administrative roles and staff permissions.",
      icon: <Shield size={18} />,
    },
    {
      id: "notifications",
      title: "Notification Center",
      desc: "Configure SMS alerts, emails, and announcements.",
      icon: <Bell size={18} />,
    },
    {
      id: "nexus",
      title: "Integrations",
      desc: "Connect with external fitness and nutrition apps.",
      icon: <Cpu size={18} />,
    },
    {
      id: "branding",
        ...
        <div className="glass-card rounded-[2rem] lg:rounded-[3rem] p-6 lg:p-12 border border-white/5 shadow-2xl relative overflow-hidden font-bold">
          {activeSubPanel === "core" && (
            <div className="flex flex-col gap-8 max-w-xl">
              <SettingField
                ...
                onChange={(val) => updateSettings({ brandName: val })}
              />
              <SettingField
          ...
          {activeSubPanel === "governance" && (
            <div className="flex flex-col gap-8 max-w-xl">
              <SettingToggle
                ...
                active={settings.mfaRequired}
                onToggle={() =>
                  updateSettings({ mfaRequired: !settings.mfaRequired })
                }
              />
              <SettingField
                label="Default Admin Level"
                value="Level 4 (Owner)"
                readOnly
              />
            </div>
          ...
          {activeSubPanel === "security" && (
            <div className="flex flex-col gap-8 max-w-xl">
              <SettingField
                ...
                onChange={(val) => updateSettings({ encryptionLevel: val })}
              />
              <button
                onClick={() =>
                  broadcastAlert("Data purge process initiated...", "warning")
                }
          ...
          {activeSubPanel === "nexus" && (
            <div className="flex flex-col gap-8 items-center justify-center py-20 text-center">
              <RefreshCcw
                size={48}
                className="text-gold/20 animate-spin-slow mb-6"
              />
              <h4 className="text-xl font-heading text-white/40 uppercase tracking-widest">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-6">
        ...
        <div className="flex items-center gap-4 w-full lg:w-auto">
          <div className="flex flex-col items-end flex-1 lg:flex-none">
            ...
            <span className="text-[8px] font-black text-gold/40 tracking-widest uppercase italic">
              By Michael Mitry
            </span>
          </div>
          <button
            onClick={() => broadcastAlert("Data reset requested.", "warning")}
            className="flex-1 lg:flex-none premium-button px-6 py-3 rounded-xl text-[9px] font-black tracking-widest uppercase text-black"
          >
            Reset Data
          </button>
        </div>
