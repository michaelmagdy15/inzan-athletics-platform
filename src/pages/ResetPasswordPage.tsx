      ...
      >
        ...
        <div className="bg-white/5 backdrop-blur-2xl rounded-3xl border border-white/10 p-8 shadow-2xl">
          ...
          <div className="flex items-center justify-center gap-2 mb-8">
            {(
              ["request", "verify", "newPassword", "success"] as ResetStep[]
            ).map((s, i) => (
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="text-center mb-6">
                <div
                  className={`inline-flex items-center justify-center w-12 h-12 rounded-full border mb-4 ${current.iconBg}`}
                >
                  {current.icon}
                </div>
                <h1 className="text-3xl font-heading tracking-[0.2em] uppercase text-white mb-2">
                  Password Recovery
                </h1>
                <p className="text-[10px] tracking-[0.4em] uppercase text-gold/60 font-medium">
