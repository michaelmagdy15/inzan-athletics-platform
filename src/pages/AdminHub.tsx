      ...
      <main className="flex-1 flex flex-col h-screen overflow-hidden relative z-10">
        <header className="h-24 border-b border-white/5 flex items-center justify-between px-10 bg-[#050505]/40 backdrop-blur-md z-20">
          <div className="flex-1 max-w-lg relative group">
            ...
            <input
              ...
              className="w-full bg-white/5 border border-white/5 rounded-2xl py-3.5 pl-14 pr-6 text-sm text-white placeholder:text-white/20 focus:outline-none focus:border-gold/30 focus:bg-white/[0.08] transition-all duration-500 shadow-inner uppercase tracking-widest text-[11px]"
            />
          </div>
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="p-5 bg-gold/5 border border-gold/10 rounded-2xl relative overflow-hidden group">
                  ...
                  <button
                    ...
                    className="premium-button w-full py-3.5 rounded-xl mt-6 group/btn overflow-hidden relative"
                  >
              ...
              <div className="flex flex-col gap-3 mt-auto">
                <button
                  ...
                  className="w-full py-4 bg-emerald-500/10 border border-emerald-500/20 hover:bg-emerald-500/20 text-emerald-400 text-[10px] font-black uppercase tracking-widest rounded-2xl transition-all font-bold"
                >
                  Renew Membership
                </button>
                <div className="grid grid-cols-2 gap-3">
                  <button
                    ...
                    className={`py-3.5 border rounded-xl text-[9px] font-black uppercase tracking-widest transition-all font-bold ${selectedMember.membershipStatus === 'active' ? 'bg-amber-500/10 border-amber-500/20 text-amber-500 hover:bg-amber-500/20' : 'bg-blue-500/10 border-blue-500/20 text-blue-400 hover:bg-blue-500/20'}`}
                  >
                  ...
                  <button
                    ...
                    className="py-3.5 bg-red-500/10 border border-red-500/20 hover:bg-red-500 text-red-500 hover:text-white text-[9px] font-black uppercase tracking-widest rounded-xl transition-all font-bold"
                  >
                    Purge Entity
                  </button>
                </div>
                ...
                <div className="flex flex-col gap-6">
                  ...
                  {creationMode === 'coach' && (
                    <>
                      ...
                      <textarea name="bio" placeholder="ASSET BIOGRAPHY" className="form-input h-24 pt-4 resize-none" />
                    </>
                  )}
                  {creationMode === 'class' && (
                    <>
        ...
        <AnimatePresence>
          {systemAlert && (
            ...
            >
              <div className="glass-card rounded-2xl border border-white/10 p-6 flex items-center justify-between shadow-2xl bg-black/80 backdrop-blur-2xl">
                <div className="flex items-center gap-5">
                  <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${systemAlert.type === 'success' ? 'bg-emerald-500/10 text-emerald-500 border-emerald-500/20' :
                    ...
                    {systemAlert.type === 'success' ? <CheckCircle2 size={24} /> :
                      systemAlert.type === 'error' ? <AlertCircle size={24} /> :
                        <Info size={24} />}
                  </div>
                  <div className="font-bold">
                    <h4 className="text-[10px] font-black uppercase tracking-[0.3em] text-white/40 mb-1">System Feedback</h4>
                    <p className="text-xs text-white font-medium tracking-wide font-bold">{systemAlert.message}</p>
                  </div>
                </div>
                <button onClick={() => setSystemAlert(null)} className="p-2 hover:bg-white/5 rounded-full transition-colors font-bold">
